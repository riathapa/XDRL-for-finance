...
# output_file = 'narcis_new_cleaned.csv'
output_file = 0
...
# Example usage
# cleaned_state_action_file = 'narcis_new_cleaned.csv'
# results_file = 'result0-100.62301206362659.csv'
# output_file = 'narcis_new_merged.csv'
# config_file = '../config.json'
#
